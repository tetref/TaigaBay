...
#[derive(Debug)]
pub struct TaigaBayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TaigaBayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TaigaBay processing");
    
    let mut processor = TaigaBayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TaigaBayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TaigaBayProcessor::new(false);
